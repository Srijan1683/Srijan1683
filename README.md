...
Worked under the DM&A vertical on NDAP-related analysis, dataset evaluation, and dashboard/reporting work.

- Analyzed sample use cases on the National Data and Analytics Platform.
- Classified use cases based on dataset completeness, relevance, and executability.
- Built Tableau dashboards and reports for state-level and platform-level insights.
...
<!--
**Srijan1683/Srijan1683** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
